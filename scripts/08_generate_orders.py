...
RETAILER_CONFIG = {
    ...
    "southside_grocers":    {"per_month": 18, "lines": (3, 6),  "units": (2,  12,   4)},
    "green_basket_market":  {"per_month": 18, "lines": (3, 6),  "units": (2,  12,   4)},
    "prairie_provisions":   {"per_month": 14, "lines": (3, 6),  "units": (2,  12,   4)},
    "mountain_pantry_co":   {"per_month": 12, "lines": (3, 5),  "units": (2,  10,   3)},
    "harbor_fresh":         {"per_month": 12, "lines": (3, 5),  "units": (2,  10,   3)},
}
...
BASE_NAME = {
    ...
    "unfi": "UNFI",
    "southside_grocers": "Southside Grocers",
    "green_basket_market": "Green Basket Market",
    "prairie_provisions": "Prairie Provisions",
    "mountain_pantry_co": "Mountain Pantry Co",
    "harbor_fresh": "Harbor Fresh",
}
...
COSTS_COL = {
    ...
    "mountain_pantry_co": "wholesale_regional",
    "harbor_fresh": "wholesale_regional",
}
